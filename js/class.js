...
function Push() {
        ...
        var gakki = $("#gakkiSelect option:selected").text();
        var whatSort = $("input[name=what]:checked").val();
        var radio = $("input[name=radio]:checked").val();

        Show(department, gakki, whatSort, radio);
}


function Show(department, gakki, whatSort, radio) {
        //JSONデータを読み込みます
                                ...
                                if (this.Classes.length > 0) {
                                        if (department == this.Classes[0].department || department == '全て') {
                                                ...
                                                for (var i = 0; i < this.Classes.length; i++) {
                                                        ...
                                                        if (this.Classes[i].gakki.indexOf(gakki[0]) !== -1 || this.Classes[0].gakki.indexOf(gakki[1]) !== -1 || gakki == '全て') {
                                                                cardCount++;
                                                                ...
                                                                $('<div class="card h-100 mb-4 pb-5">' +
                                                                        '<div class="card-body">' +
                                                                        '<div class="text-center"><h5 class="card-title"><strong>' + this.Classes[i].name + '</strong></h5><p>' +
                                                                        this.Classes[i].department + '</p><p>' + this.Classes[i].gakki + '</p></div>' +
